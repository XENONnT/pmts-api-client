...
[**patch_account_item**](AccountApi.md#patch_account_item) | **PATCH** /accounts/{accountId} | Updates a Account document
...
# **get_accounts**
> InlineResponse200 get_accounts(where=where, projection=projection, sort=sort, page=page, max_results=max_results)
...
max_results = 25 # int | the max results query parameter (optional)
    ...
    try:
        # Retrieves one or more Accounts
        api_response = api_instance.get_accounts(where=where, projection=projection, sort=sort, page=page, max_results=max_results)
        pprint(api_response)
    except ApiException as e:
...
# **patch_account_item**
> patch_account_item(account_id, account, if_match=if_match)

Updates a Account document
...
if_match = 'if_match_example' # str | Current value of the _etag field (optional)
    ...
    try:
        # Updates a Account document
        api_instance.patch_account_item(account_id, account, if_match=if_match)
    except ApiException as e:
        print("Exception when calling AccountApi->patch_account_item: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Account document updated successfully |  -  |
**0** | An error message |  -  |
